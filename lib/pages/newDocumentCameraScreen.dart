...
import 'package:camera_plugin/camera.dart';
 ...
 @override
  void initState() {
    ...
    controller.initialize().then((_) async {
      ...
      flashMode =  await controller.getFlashMode();
      setState(() {
  ...
  void takePicture() async{
    ...
    final String dirPath = '${extDir.path}/Pictures/taxxo_mobile';
      ...
      child: new AppBar( 
        ...
        actions: <Widget>[
          new GestureDetector(
              ...
              onTap: ()=> setState(() => changeFlashMode() ),
          )
        ])
    );
  ...
  changeFlashMode(){
    ...
    setState(()=> flashMode = newFlashMode);
  }
